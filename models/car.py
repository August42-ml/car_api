...
# class DetailsToChange(SQLModel):
...
# class OutcomesSummary(SQLModel):
#     total_outcomes: int
#     service_outcomes: int
#     details_outcomes: int

# class DetailsMileageSummary(SQLModel):
#     engine_oil_mileage_left: int
#     gearbox_oil_mileage_left: int
#     engine_belts_and_timmig_mileage_left: int
#     antifreeze_liquid_mileage_left: int
#     air_cabin_filter_mileage_left: int
#     air_engine_filter_mileage_left: int
#     spark_plugs_mileage_left: int